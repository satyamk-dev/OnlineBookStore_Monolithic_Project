package com.nareshit.filter; //  Make sure this matches SecurityConfig import
...
import com.nareshit.utility.JwtUtilService;
 ...
 * ------------------------------------------------ This filter runs once per
 * request and performs: 1️ Extract JWT token from the "Authorization" header.
 * 2️ Validate the token using JwtUtilService. 3️ If valid, set the
